...
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports {segnum[0]}]
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVCMOS33} [get_ports {segnum[1]}]
set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports {segnum[2]}]
set_property -dict {PACKAGE_PIN W4 IOSTANDARD LVCMOS33} [get_ports {segnum[3]}]
